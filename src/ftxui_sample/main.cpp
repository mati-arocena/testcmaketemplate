...
// configuration step. It creates a namespace called `testcmaketemplate`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", testcmaketemplate::cmake::project_name, testcmaketemplate::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", testcmaketemplate::cmake::project_version);
      return EXIT_SUCCESS;
    }
